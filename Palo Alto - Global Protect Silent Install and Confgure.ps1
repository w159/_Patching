...
Invoke-WebRequest -UseBasicParsing 'https://onedrive.live.com/download?resid=af928892ebcfb343%21567248&authkey=!AE4dyZwJs07crC0' -OutFile 'C:\Utils\GlobalProtect64-6.2.2.msi'
...
if ($GlobalProtectVersion -ne '6.2.2') {
    Start-Process -FilePath 'C:\Utils\GlobalProtect64-6.2.2.msi' -ArgumentList '/quiet /L*V "C:\Utils\PAGlobalProtectInstaller.log"' -WindowStyle Hidden -Wait
}
