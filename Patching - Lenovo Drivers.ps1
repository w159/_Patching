Get-ScheduledTask | Where-Object TaskName -EQ 'S5 - Lenovo Updater' | Unregister-ScheduledTask -Confirm:$false -ErrorAction SilentlyContinue
...
"@
    ...
    Register-ScheduledTask -TaskName 'Lenovo Updater v4.4.24' -Trigger $Trigger -User $User -Action $Action -Settings $Settings `
        -RunLevel Highest `
        -Description 'This installs Lenovo System Update and updates Drivers and BIOS to latest. Created by JM - Last Updated 4.4.24' -Force
}