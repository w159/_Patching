...
Get-ScheduledTask | Where-Object TaskName -EQ 'Office Updater' | Unregister-ScheduledTask -Confirm:$false -ErrorAction SilentlyContinue
...
Register-ScheduledTask -TaskName 'Office Updater v4.4.24' -Trigger $Trigger, $TriggerLogon -User $User -Action $Action -Settings $Settings -RunLevel Highest -Force -Description 'This task should update x32 and x64 versions of Microsoft Office apps. Created by JM Last updated 4.4.24'
