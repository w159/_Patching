Get-ScheduledTask | Where-Object TaskName -EQ "S5 - Intune Hourly Sync" | Unregister-ScheduledTask -Confirm:$false -ErrorAction SilentlyContinue
...
$TaskName_AppSync = 'S5 - Intune App Sync'
...
$TaskName_CompSync = 'S5 - Intune Compliance Sync'
